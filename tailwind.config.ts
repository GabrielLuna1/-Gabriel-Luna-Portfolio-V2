...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        'display-lg': ['clamp(2.5rem, 5vw, 4.5rem)', { lineHeight: '1.05', letterSpacing: '-0.04em' }],
        'display-xl': ['clamp(3rem, 6vw, 5.5rem)', { lineHeight: '1.02', letterSpacing: '-0.04em' }],
        'display': ['clamp(2rem, 4vw, 3.5rem)', { lineHeight: '1.08', letterSpacing: '-0.035em' }],
        'heading': ['clamp(1.5rem, 3vw, 2.5rem)', { lineHeight: '1.15', letterSpacing: '-0.025em' }],
        'subheading': ['clamp(1.125rem, 2vw, 1.5rem)', { lineHeight: '1.3', letterSpacing: '-0.015em' }],
      ...
      keyframes: {
        ...
        pulseGlow: {
          '0%, 100%': { boxShadow: '0 0 15px rgba(59, 130, 246, 0.12)' },
          '50%': { boxShadow: '0 0 25px rgba(59, 130, 246, 0.22)' },
        },
        float: {
